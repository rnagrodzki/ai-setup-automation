# `/aisa:setup` — Initialize AI configuration for a project
...
- [`/aisa:validate`](validate.md) — check new skills against architectural principles
- [`/aisa:target`](target.md) — update specific skills after shipping a feature
