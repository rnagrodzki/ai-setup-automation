...
(only deep-audit files whose hashes changed). See `ai-evolve-cache` skill for protocol.
...
in `.claude/skills/ai-evolve-principles/SKILL.md` (Skill P1-P3, Agent A1-A6).
